    ...
    <div class="container navi">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-9 text-right">
                <h4 class="px-3 bigS"><a href="/" class="text" id="home">Home</a></h4>
                <h4 class="px-3 bigS"><a href="/contact" class="text" id="contact">Contact</a></h4>
        ...
        <div class="navi-mobile">
            <div class="d-flex flex-column">
                <h4><a href="/" class="text">Home</a></h4>
